...
source_folder = "E:/plantpro/data/eggplant_data"
...
target_folder = "E:/plantpro/data/datasetformodel"
...
exitsDataSetPath = os.path.exists(trainPath)
if existDataSetPath == False:
    os.mkdir(trainPath)

exitsDataSetPath = os.path.exists(validatePath)
if existDataSetPath==False:
